            ...
            >
               <div className="grid grid-cols-3 items-center w-full px-12 sm:px-16 xl:px-24 py-3 md:py-4 gap-4 md:gap-8">
                  <div className="flex justify-center items-center">
                     <img src={srecLogo} alt="SREC" className="h-30 sm:h-24 md:h-32 lg:h-36 w-auto object-contain flex-shrink-0" />
                  </div>
                  <div className="flex justify-center items-center">
                     <img src={ieeeLogo} alt="IEEE" className="h-50 sm:h-24 md:h-32 lg:h-36 w-auto object-contain flex-shrink-0" />
                  </div>
                  <div className="flex justify-center items-center">
                     <img src={snrLogo} alt="SNR Trust" className="h-55 sm:h-24 md:h-32 lg:h-36 w-auto object-contain flex-shrink-0" />
                  </div>
               </div>
            </motion.div>
